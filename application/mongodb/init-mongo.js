...
db.patients.insertMany(
  [
    ...
    },
    {
      ...
      address: "6725, Szeged, Tavasz utca, 14",
  ...
  [
    {
      ...
      weight: 11,
      birthday: "2018-06-21",
      record: ["e1f1b640-6fc5-4cc7-bc84-10ddf815ab87"],
      alive: true,
      neutralised: false
    },
    {
      pid: "c83e6b0f-0f89-4ec2-8b45-9b6a513aa119",
      chipid: "985141000654321",
      name: ["Cirmi"],
      species: ["macska"],
      breed: ["házi"],
      colour: "cirmos",
      ...
      weight: 4,
      birthday: "2018-03-14",
      record: ["e1f1b640-6fc5-4cc7-bc84-10ddf815ea87",
        "e2f1b210-6fc5-4cc7-bc84-10ddf815ab87"
      ],
      alive: true,
      neutralised: true
    },
    {
      ...
      weight: 18,
      birthday: "2017-11-02",
      record: ["e1f1b640-6fc5-4cc7-bc84-13ddf815ea83"],
      alive: true,
      neutralised: false
    },
    {
...
db.records.insertMany(
  [
    {
      rid: "e1f1b640-6fc5-4cc7-bc84-10ddf815ea87",
      date: "2025-09-15T18:33:21",
      vaccination: [
        { value: "PREVOMAX INJ.", label: "PREVOMAX INJ." },
      ],
      treatment: [
        { notes: "ezt meg azt kapott" }
      ],
      weight: 13.3,
      note: "minek ebbe a kutyába ennyi oltás, úgyis megdöglik"
    },
    {
      rid: "e1f1b640-6fc5-4cc7-bc84-13ddf815ea83",
      date: "2025-09-17T17:33:21",
      vaccination: [
      ...
      weight: 13.2,
      note: "még mindig minek ebbe a kutyába ennyi oltás, úgyis megdöglik"
    },
    {
      rid: "e1f1b640-6fc5-4cc7-bc84-10ddf815ab87",
      date: "2024-09-17T17:33:21",
      vaccination: [
    ...
    {
      rid: "e2f1b210-6fc5-4cc7-bc84-10ddf815ab87",
      date: "2024-09-22T18:33:21",
      vaccination: [
        { value: "MILPRAZON TABL. 2,5/25 MG", label: "MILPRAZON TABL. 2,5/25 MG" },
        { value: "OTOACT 100 ML", label: "OTOACT 100 ML" }
      ],
      treatment: [
        { notes: "beadtam neki, ízlett neki" }
      ],
      weight: 14.9,
      note: "ivartalanítás, sok oltás, megsimogattam"
    }
  ]
);
...
db.drugs.insertMany(
  [
    ...
    { value: "EPIOTIC 125 ML", label: "EPIOTIC 125 ML" },
    { value: "OTIMAX 100 ML", label: "OTIMAX 100 ML" },
    { value: "OTODEZACIN FÜLCSEPP", label: "OTODEZACIN FÜLCSEPP" },
    { value: "OTOMICOL FÜLCSEPP", label: "OTOMICOL FÜLCSEPP" },
    { value: "EASOTIC FÜLCSEPP", label: "EASOTIC FÜLCSEPP" },
    { value: "NEXGARD COMBO MACSKA 2,5-7,5 KG", label: "NEXGARD COMBO MACSKA 2,5-7,5 KG" },
